...
func AddGroup(c *gin.Context) {
	...
	if flag == false{
		c.JSON(200,gin.H{"type":"gateway","statusCode":"150000",})
		return 
	}else{
		c.JSON(200,gin.H{"type":"gateway","statusCode":"000000","groupID":groupID,})
		return 
	}
...
func GetGroupList(c *gin.Context) {
	...
	if flag == false{
		...
		c.JSON(200,gin.H{"type":"gateway","statusCode":"000000","groupList":groupList,})
		return 
}
}
...
func GetGroupName(c *gin.Context) {
	...
	if flag == false{
		...
		c.JSON(200,gin.H{"type":"gateway","statusCode":"000000","groupName":groupName})
		return 
	}
}